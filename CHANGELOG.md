...
## [0.9.0](https://github.com/euxaristia/zero/compare/v0.8.0...v0.9.0) (2026-09-15)


### Features

* **acp:** add standard session list and resume ([#914](https://github.com/euxaristia/zero/issues/914)) ([c1937df](https://github.com/euxaristia/zero/commit/c1937dfac72e6ad0e5ade6e48e2d9c17d9c3e5d6))
* **acp:** emit structured file changes in tool updates ([#999](https://github.com/euxaristia/zero/issues/999)) ([faec8ee](https://github.com/euxaristia/zero/commit/faec8ee2017fdd6d0c2c347add892cb73eb413d7))
* **acp:** surface safe browser tool metadata ([#1000](https://github.com/euxaristia/zero/issues/1000)) ([a6ec043](https://github.com/euxaristia/zero/commit/a6ec0435e36b9bea9793b2fd97f2ecd30e3a0f9b))
...
* add persistent session goals ([#803](https://github.com/euxaristia/zero/issues/803)) ([5d1869e](https://github.com/euxaristia/zero/commit/5d1869e7bc193c97e07418b57b823905c1151d5d))
...
* **agent:** add PermissionModePlan for interactive read-only planning ([#853](https://github.com/euxaristia/zero/issues/853)) ([0176ee4](https://github.com/euxaristia/zero/commit/0176ee49ffddcff6f7edf6ae2ade4967e5b22cc3))
...
* **exec:** default headless runs to the turn-budget ceiling ([#1049](https://github.com/euxaristia/zero/issues/1049)) ([9e609c5](https://github.com/euxaristia/zero/commit/9e609c52420fd322f047fc238c04ac81dd623fdd))
...
* **providers:** add Fireworks AI provider preset ([#772](https://github.com/euxaristia/zero/issues/772)) ([58daea7](https://github.com/euxaristia/zero/commit/58daea7a482927e5ab35afaf97761c60bb35e113))
...
* **providers:** live model lists for OpenRouter and OpenGateway ([#860](https://github.com/euxaristia/zero/issues/860)) ([fb4f293](https://github.com/euxaristia/zero/commit/fb4f293c20eb860ca388a10d22fd566ce282ba1f))
...
* **security:** path-jail primitive, credential-store locking, worktree git hardening ([#891](https://github.com/euxaristia/zero/issues/891)) ([060d38c](https://github.com/euxaristia/zero/commit/060d38ce716feb7c5b6657b082cd35cb8dda3d75))
...
* **skills:** report hash drift in skill info ([#795](https://github.com/euxaristia/zero/issues/795)) ([9fbdc34](https://github.com/euxaristia/zero/commit/9fbdc341551601c13434cf7b9b6f5e4ea4c483b1))
...
* **tools:** give tool results an image channel and add view_image ([#843](https://github.com/euxaristia/zero/issues/843)) ([cd0eb19](https://github.com/euxaristia/zero/commit/cd0eb194e4df4b844785796c0701216740a56344))
...
* **tui:** interactive terminal attach for tty exec sessions ([#1055](https://github.com/euxaristia/zero/issues/1055)) ([d73ec81](https://github.com/euxaristia/zero/commit/d73ec81e2d3facb5377bc9ad0fe2aa314628a0c0))
* **tui:** offer mid-run model escalation behind --allow-escalation ([#1019](https://github.com/euxaristia/zero/issues/1019)) ([91d921f](https://github.com/euxaristia/zero/commit/91d921f4c5b8289a9e437f786218f1b48f2add5a))
...
* **tui:** replace /retitle with local /rename ([#826](https://github.com/euxaristia/zero/issues/826)) ([5886354](https://github.com/euxaristia/zero/commit/588635487f22ef4d62d350140a219b7b8bb24119))
* **tui:** richer /resume session browser ([#1047](https://github.com/euxaristia/zero/issues/1047)) ([2f53117](https://github.com/euxaristia/zero/commit/2f531178f614e587b629e4f81e0470adda647fbd))
...
* **update:** recognise Homebrew installs and add mise, go install docs ([#910](https://github.com/euxaristia/zero/issues/910)) ([01c3498](https://github.com/euxaristia/zero/commit/01c3498205e69d26e5f929225f9455b276444f39))
* use Exa as default search provider ([#926](https://github.com/euxaristia/zero/issues/926)) ([1ec7219](https://github.com/euxaristia/zero/commit/1ec7219aee7b2840481ab0905f131644e27d2a4e))
...
* **zerogit:** auto-create a conventional branch before push/pr on default branch ([#671](https://github.com/euxaristia/zero/issues/671)) ([d065467](https://github.com/euxaristia/zero/commit/d065467cd3ec3ed91c5dc60554c36fc4b4d6de4c))


### Bug Fixes

* **acp:** interrupt idle reads on cancellation ([#782](https://github.com/euxaristia/zero/issues/782)) ([15b7a54](https://github.com/euxaristia/zero/commit/15b7a5475cfeefddbc59634551451a8872b996b7))
* **acp:** make configured MCP tools callable ([#1003](https://github.com/euxaristia/zero/issues/1003)) ([7f5e5af](https://github.com/euxaristia/zero/commit/7f5e5af7bbdbe5bb4d91706146072d461c0234a4))
...
* **acp:** three defects a desktop ACP client hits ([#915](https://github.com/euxaristia/zero/issues/915)) ([a78c6c3](https://github.com/euxaristia/zero/commit/a78c6c357e1d21146d7cd2e8030a754e06f7f1f5))
...
* **agent:** end the additional_permissions retry loop ([#864](https://github.com/euxaristia/zero/issues/864)) ([4ca4fa7](https://github.com/euxaristia/zero/commit/4ca4fa75d31b139dbe55a3badf17da86892ab001))
...
* **agent:** stop the tool-schema ratchet meaning a different thing per host ([#1017](https://github.com/euxaristia/zero/issues/1017)) ([f909266](https://github.com/euxaristia/zero/commit/f9092668a832ea73a69551f0ea2df4f6eaf356df))
...
* **agent:** tell the user a prefix approval leaves the sandbox ([#885](https://github.com/euxaristia/zero/issues/885)) ([2ec5c3a](https://github.com/euxaristia/zero/commit/2ec5c3ae6b8fb543887bdeafdb34c4da057b8d36))
...
* **background:** treat POSIX zombie leader as already-exited ([#981](https://github.com/euxaristia/zero/issues/981)) ([1aacf38](https://github.com/euxaristia/zero/commit/1aacf38b727d31b5ca09949316d6afa8292aec46))
...
* bump Go to 1.26.6 for stdlib vulnerability fixes ([#903](https://github.com/euxaristia/zero/issues/903)) ([dc15e82](https://github.com/euxaristia/zero/commit/dc15e822987d8d7de467c62c375518f435b74d8c))
...
* **cli:** report MCP servers that failed to start ([#822](https://github.com/euxaristia/zero/issues/822)) ([#827](https://github.com/euxaristia/zero/issues/827)) ([021281e](https://github.com/euxaristia/zero/commit/021281ebbab3f2bbe6a77b2dab4bf121bcfe6b52))
...
* **config:** lock config read-modify-write across processes ([#960](https://github.com/euxaristia/zero/issues/960)) ([b04fe96](https://github.com/euxaristia/zero/commit/b04fe96e9ef3f2deda4fb2a972270300629079d2))
* **config:** make the provider-command timeout an upper bound ([#811](https://github.com/euxaristia/zero/issues/811)) ([#813](https://github.com/euxaristia/zero/issues/813)) ([1c38e8c](https://github.com/euxaristia/zero/commit/1c38e8cba50db255f3cda8b7cf4298712b2933e1))
* **config:** preserve unknown top-level fields ([#984](https://github.com/euxaristia/zero/issues/984)) ([488def6](https://github.com/euxaristia/zero/commit/488def68dcc6d36701fdf171e94a74a436b090fc))
* **config:** stop billing provider-command fixtures to the 5s timeout ([#810](https://github.com/euxaristia/zero/issues/810)) ([f5fa4ff](https://github.com/euxaristia/zero/commit/f5fa4ffc64537897aa78a56edca36d8f1dacd021))
...
* **daemon:** clean up child after startup timeout ([#774](https://github.com/euxaristia/zero/issues/774)) ([9c29209](https://github.com/euxaristia/zero/commit/9c292092a26c9092fd873d072b0af1b0d9d39ef0))
...
* **daemon:** publish status files atomically ([#949](https://github.com/euxaristia/zero/issues/949)) ([9001421](https://github.com/euxaristia/zero/commit/90014210d2ada2e3d61f4eca5087d3f35a3c4b8b))
* **dictation:** redact API keys from streaming transcriber errors ([#852](https://github.com/euxaristia/zero/issues/852)) ([64a783b](https://github.com/euxaristia/zero/commit/64a783b08caa2c7b21f188033b9ed84a14e00e84))
...
* **installtxn:** put back an install a killed commit left behind ([#997](https://github.com/euxaristia/zero/issues/997)) ([2837f5e](https://github.com/euxaristia/zero/commit/2837f5efb38dcd3c69771b0ba31565f98a206120))
...
* let the configured forward proxy through the loopback guard ([#1025](https://github.com/euxaristia/zero/issues/1025)) ([1e4db7c](https://github.com/euxaristia/zero/commit/1e4db7c6643ca7e2c3d8e4b8b30371cfbe43561e))
* **lint:** resolve static analysis baseline ([#769](https://github.com/euxaristia/zero/issues/769)) ([583e653](https://github.com/euxaristia/zero/commit/583e6530bd849a8efcb2b88bbe8c297e8592e62c))
...
* **lockutil:** use kernel-held advisory locks ([#950](https://github.com/euxaristia/zero/issues/950)) ([6fe0d1e](https://github.com/euxaristia/zero/commit/6fe0d1edcdbadea6d566800fbcca739c1cd54ea1))
* **lsp:** dispatch notifications off read loop ([#759](https://github.com/euxaristia/zero/issues/759)) ([936aa4e](https://github.com/euxaristia/zero/commit/936aa4e77cf49738560a89395b8ba4d22263a396))
...
* **mcp:** discover OAuth through protected resource metadata ([#991](https://github.com/euxaristia/zero/issues/991)) ([1b5db17](https://github.com/euxaristia/zero/commit/1b5db1765672820caac1684b168c9898b5ba3593))
* **mcp:** name the non-text blocks a tool result drops ([#874](https://github.com/euxaristia/zero/issues/874)) ([027a670](https://github.com/euxaristia/zero/commit/027a67080bea511b876c284bc911ef011eceb308))
* **mcp:** reject a server-initiated request as a streamable-HTTP response ([#1054](https://github.com/euxaristia/zero/issues/1054)) ([2479d94](https://github.com/euxaristia/zero/commit/2479d946c15dbf74ee3c04a637e97181d1786f08))
...
* **modelregistry:** expose reasoning effort for DeepSeek V4 models ([#931](https://github.com/euxaristia/zero/issues/931)) ([90dcfd1](https://github.com/euxaristia/zero/commit/90dcfd127e8a6d9902ec9f4e72f6d03fef1a0fc6))
...
* **oauth:** force-close loopback callback connections past the shutdown deadline ([#1051](https://github.com/euxaristia/zero/issues/1051)) ([176f5a2](https://github.com/euxaristia/zero/commit/176f5a242b754a86ea4c7121a8dcc1c0d72cf2e4))
...
* **oauth:** Split an oversized keyring token blob across entries ([#1007](https://github.com/euxaristia/zero/issues/1007)) ([275e248](https://github.com/euxaristia/zero/commit/275e2486695338ce38193a6e3319f8b6a9a5c33c))
...
* **providers:** discover ChatGPT capabilities ([#890](https://github.com/euxaristia/zero/issues/890)) ([2d2450e](https://github.com/euxaristia/zero/commit/2d2450e9a744349f0d01b1d4e9ba29c24ba5650d))
* **providers:** register Atomic Chat as local OpenAI-compatible runtime ([#550](https://github.com/euxaristia/zero/issues/550)) ([79fa142](https://github.com/euxaristia/zero/commit/79fa1422ef1a3691b93342788453ebc284d57f9c))
* **providers:** retry provably pre-send transport failures ([#447](https://github.com/euxaristia/zero/issues/447)) ([#750](https://github.com/euxaristia/zero/issues/750)) ([8acd42a](https://github.com/euxaristia/zero/commit/8acd42a3bd743a35807d762f23a33fb61c171839))
...
* **redaction:** split camelCase keys in normalizeKey ([#994](https://github.com/euxaristia/zero/issues/994)) ([08fbea7](https://github.com/euxaristia/zero/commit/08fbea7a3221d2061d88038924f90a4cba9af1ac))
* **sandbox:** add platform-specific write lock around grant state file ([#752](https://github.com/euxaristia/zero/issues/752)) ([#755](https://github.com/euxaristia/zero/issues/755)) ([88fb7b6](https://github.com/euxaristia/zero/commit/88fb7b6192c1ac8173089967d5e9119f92d7a101))
...
* **sandbox:** clarify scoped permission prompts ([#798](https://github.com/euxaristia/zero/issues/798)) ([9fe02ae](https://github.com/euxaristia/zero/commit/9fe02ae52e3234cb9dae76e0c5594a287ccbb52a))
* **sandbox:** deny reads of git's credential stores ([#815](https://github.com/euxaristia/zero/issues/815)) ([#816](https://github.com/euxaristia/zero/issues/816)) ([33c94ec](https://github.com/euxaristia/zero/commit/33c94ec7a3e7987e6e36b5fd5e037ff4e6e84c26))
* **sandbox:** deny reads of Zero credential stores ([#681](https://github.com/euxaristia/zero/issues/681)) ([55fa05f](https://github.com/euxaristia/zero/commit/55fa05f0ab5a01b495345d43464606cd19a31b4f))
...
* **sandbox:** keep a derived ACL target inside the write root it came from ([#1040](https://github.com/euxaristia/zero/issues/1040)) ([3b43c43](https://github.com/euxaristia/zero/commit/3b43c43eca968c8619adadc81fcc1a17e220216a))
* **sandbox:** keep Windows restricted-token SIDs narrow and fail closed on DenyRead ([#1006](https://github.com/euxaristia/zero/issues/1006)) ([0207f2b](https://github.com/euxaristia/zero/commit/0207f2b2697149a73ecc89a5ab5db0bd665f1911))
* **sandbox:** Make WSL backend tests deterministic. ([#948](https://github.com/euxaristia/zero/issues/948)) ([e59bf78](https://github.com/euxaristia/zero/commit/e59bf78cabc2703678778b904c27c8bc8ef82bc8))
* **sandbox:** normalize launcher names before the command-prefix denylist ([#934](https://github.com/euxaristia/zero/issues/934)) ([6edf9a8](https://github.com/euxaristia/zero/commit/6edf9a8b78dc030dc44598919db1c7fa9d4f809a))
* **sandbox:** preserve user config and retry denied writes ([#801](https://github.com/euxaristia/zero/issues/801)) ([81a5e6c](https://github.com/euxaristia/zero/commit/81a5e6cb716ba4b7ecf7ff3ff261dfa51fd01098))
* **sandbox:** protect worktree git pointers ([#805](https://github.com/euxaristia/zero/issues/805)) ([f30f550](https://github.com/euxaristia/zero/commit/f30f550e6037c53f8521ba2d59c984ae6c574917))
* **sandbox:** refcount temporary roots so one holder's cleanup cannot revoke another's ([#911](https://github.com/euxaristia/zero/issues/911)) ([7acac7a](https://github.com/euxaristia/zero/commit/7acac7acee65565e25089f2a7b5813c086ce65eb))
...
* **sandbox:** scrub the daemon token file pointer ([#677](https://github.com/euxaristia/zero/issues/677)) ([#818](https://github.com/euxaristia/zero/issues/818)) ([3e7692d](https://github.com/euxaristia/zero/commit/3e7692d8f0885d346809869935c81a9cf055d89e))
...
* **sandbox:** stop the Windows write jail honouring Everyone-granted paths ([#865](https://github.com/euxaristia/zero/issues/865)) ([91b413c](https://github.com/euxaristia/zero/commit/91b413c514cc1607d5b4e7936780d40569239814))
...
* **secrets,worktrees:** fix secret redaction leakage and prune stale worktrees ([#855](https://github.com/euxaristia/zero/issues/855)) ([ff62f73](https://github.com/euxaristia/zero/commit/ff62f73b7f4dc5e2472db21acba43cf6140c06d1))
...
* **sessions:** carry an interrupted turn's work into the resume prompt ([#1016](https://github.com/euxaristia/zero/issues/1016)) ([6ae8396](https://github.com/euxaristia/zero/commit/6ae8396f0282a5f18a431f0c0ef1a272ecc2ca2b))
* **sessions:** render resume context fields in key order ([#1043](https://github.com/euxaristia/zero/issues/1043)) ([da244bc](https://github.com/euxaristia/zero/commit/da244bcbfcfa05e414567ac0acc3cf8ba745ad7d))
...
* **specialist:** keep the pinned model when a specialist is resumed ([#1009](https://github.com/euxaristia/zero/issues/1009)) ([aadb4a2](https://github.com/euxaristia/zero/commit/aadb4a27e9cdb41e774e8e1a8f23cf9c2fb50db2))
* **specialist:** make overwrites atomic ([#757](https://github.com/euxaristia/zero/issues/757)) ([30f6d8f](https://github.com/euxaristia/zero/commit/30f6d8f591a0b81638b4182ff56c86c8a50a5c70))
* suppress gosec G204 warning for trusted local config commands ([#848](https://github.com/euxaristia/zero/issues/848)) ([c52db05](https://github.com/euxaristia/zero/commit/c52db055b0b213758a33c5c5627a411e052f8de4))
* **swarm:** close lifecycle admission on shutdown ([#776](https://github.com/euxaristia/zero/issues/776)) ([bdbda89](https://github.com/euxaristia/zero/commit/bdbda89f3e42d93e8058ab3e1e9ef402659530cd))
* **swarm:** stop original member before handoff ([#957](https://github.com/euxaristia/zero/issues/957)) ([0021475](https://github.com/euxaristia/zero/commit/0021475d4c58c91911098f414795512cf60a0b56))
...
* **tools:** an edit keeps the reads it did not disturb ([#908](https://github.com/euxaristia/zero/issues/908)) ([1649008](https://github.com/euxaristia/zero/commit/1649008506da0e675431dc056251a01891b15cc8))
...
* **tools:** make apply_patch tolerant and re-expose edit_file ([#956](https://github.com/euxaristia/zero/issues/956)) ([2749447](https://github.com/euxaristia/zero/commit/2749447cdce4ae5dd333538b36fa919b80ecc66d))
...
* **tools:** reject fuzzy edits with drifted content ([#983](https://github.com/euxaristia/zero/issues/983)) ([8b3d1b1](https://github.com/euxaristia/zero/commit/8b3d1b1597b04bfa6d4bc7f912abc13ca80a6298))
...
* **tools:** say when format-on-write ran out of time ([#1044](https://github.com/euxaristia/zero/issues/1044)) ([6937a30](https://github.com/euxaristia/zero/commit/6937a309cf00825572210a7610a1f3ea8b74c2f9))
...
* **tui:** a copied NUL byte no longer panics the TUI on Windows ([#876](https://github.com/euxaristia/zero/issues/876)) ([cae0269](https://github.com/euxaristia/zero/commit/cae0269e77e7a0a493cf799b41c653c9ff9a19de)), closes [#875](https://github.com/euxaristia/zero/issues/875)
...
* **tui:** exclude permission waits from turn time ([#820](https://github.com/euxaristia/zero/issues/820)) ([15eb16f](https://github.com/euxaristia/zero/commit/15eb16f736f903c94203207032f98aacbcf06318))
* **tui:** fall back to CellMotion where AllMotion is unreliable ([#872](https://github.com/euxaristia/zero/issues/872)) ([7fbd864](https://github.com/euxaristia/zero/commit/7fbd864e91433441489902571ea394ebc5b7bd0d))
* **tui:** fill alt-screen frame with theme panel background ([#850](https://github.com/euxaristia/zero/issues/850)) ([020c28e](https://github.com/euxaristia/zero/commit/020c28eaf95e2f38853f99fc06a13cd1568bf3c9))
...
* **tui:** hide unavailable sidebar shortcut ([#821](https://github.com/euxaristia/zero/issues/821)) ([845df6c](https://github.com/euxaristia/zero/commit/845df6c7d28e02f475e90acfe838733eb37e6aa2))
...
* **tui:** move voice capture to Ctrl+Space ([#968](https://github.com/euxaristia/zero/issues/968)) ([eeea330](https://github.com/euxaristia/zero/commit/eeea3308fed38b37b203522624babaf2f30df91f))
* **tui:** paste clipboard images with Ctrl+V ([#534](https://github.com/euxaristia/zero/issues/534)) ([#807](https://github.com/euxaristia/zero/issues/807)) ([ec3b822](https://github.com/euxaristia/zero/commit/ec3b8225050eb62f0f41a9582ed2881d2f9dcc8e))
...
* **tui:** reset quiet clock for new runs ([#799](https://github.com/euxaristia/zero/issues/799)) ([a4a805a](https://github.com/euxaristia/zero/commit/a4a805a6c82c51cb255e909bd87ca183c8805cf2))
...
* **update:** keep Windows failed-restore state in trusted recovery records ([#979](https://github.com/euxaristia/zero/issues/979)) ([a3852ba](https://github.com/euxaristia/zero/commit/a3852bac595e06c5d3ca9da22212b281b8796802))
...
* use OAuth credentials in provider health checks ([#828](https://github.com/euxaristia/zero/issues/828)) ([d37de92](https://github.com/euxaristia/zero/commit/d37de9214b1ba86542f4f5ef3b060bb96849763b))
...
* **windows:** use PowerShell for command execution ([#804](https://github.com/euxaristia/zero/issues/804)) ([518d2e5](https://github.com/euxaristia/zero/commit/518d2e53ba3fa073090a9b41c278face85b59b64))


### Performance Improvements

* **agent:** cheap compaction — dedicated summarizer model, input cap… ([#532](https://github.com/euxaristia/zero/issues/532)) ([6645f97](https://github.com/euxaristia/zero/commit/6645f9744b37dda4d52ecc4631578d62cefc89de))
...
* compact common test output ([#846](https://github.com/euxaristia/zero/issues/846)) ([edf660a](https://github.com/euxaristia/zero/commit/edf660ab85131f90a452cee51dc2c3a5cf62d632))
...
* improve harness context efficiency ([#838](https://github.com/euxaristia/zero/issues/838)) ([8e26679](https://github.com/euxaristia/zero/commit/8e266797a8305e689806eadcf9698da2796481ab))
...
* **providers:** parallelize isolated provider unit tests and shrink retry backoffs ([#955](https://github.com/euxaristia/zero/issues/955)) ([d6b25fc](https://github.com/euxaristia/zero/commit/d6b25fc3039a6b7d72a5703a87a097449792b102))
...
* reduce startup and turn overhead ([#932](https://github.com/euxaristia/zero/issues/932)) ([1fde941](https://github.com/euxaristia/zero/commit/1fde941803c4295c11a4a14559f3c5217d1a9e69))
