...
func reset(s *cursedRenderer) {
	...
	scr.SetScrollOptim(runtime.GOOS != "windows" && os.Getenv("ZERO_DEBUG_NO_SCROLL_OPTIM") == "") // TEMP DEBUG PATCH: also disable via env var to test terminals reached through a remote hop
	s.scr = scr
}
